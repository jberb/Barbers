...
function About() {
  return (
    <div
      id="about"
      className="pt-10 bg-orange-100 p-10 flex flex-col sm:items-center sm:flex-row sm:gap-10 sm:px-40 sm:p-12"
    >
      <div className="sm:w-1/2 p-10">
        <h1 className=" py-3 text-neutral-600 font-poppins">UNIQUE STORY</h1>
        <h2 className=" text-yellow-400 font-bold text-3xl py-3 font-poppins">
      ...
      <img className="py-10 sm:p-10 sm:w-1/2 sm:h-96 " src={B2}></img>
    </div>
  );
}
